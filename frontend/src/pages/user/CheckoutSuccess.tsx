...
import { CheckCircle, MapPin, Clock, ArrowRight, Sparkles, Package, TruckIcon, ChefHat, HeartHandshake } from 'lucide-react';
      ...
      >
        ...
        <div className="relative inline-flex items-center justify-center w-32 h-32 mb-8 mx-auto group">
          <motion.div
            ...
            className="absolute inset-0 bg-gradient-to-tr from-green-400 to-emerald-600 rounded-full shadow-[0_0_40px_rgba(52,211,153,0.4)]"
          />
          <motion.div
            animate={{ rotate: 360 }}
            transition={{ duration: 8, repeat: Infinity, ease: "linear" }}
            className="absolute -inset-4 border border-green-400/30 rounded-full border-dashed"
          />
