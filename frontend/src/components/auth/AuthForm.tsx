...
export function AuthForm({ role, onBack }: AuthFormProps) {
  ...
  const API_BASE_URL = ((import.meta as any).env?.VITE_API_URL?.endsWith('/api') ? (import.meta as any).env?.VITE_API_URL : `${(import.meta as any).env?.VITE_API_URL || 'https://quickeatsbackend.onrender.com'}/api`);
